...
/**
 * The route of the saga directory SCREEN, declared through resource metadata like every route of
 * this surface, which is what keeps it out of the published docs and behind the same actor gate.
 *
 * The path mirrors the JSON pair it renders: the plural is the directory, as `/_storm/sagas` is, and
 * the singular next to it is one instance.
 */
#[ApiResource(
    shortName: 'StormSagaListingView',
    operations: [
        new Get(
            uriTemplate: '/_storm/view/sagas',
            // the navigation generates by NAME; a generated route name would change under us
            name: 'storm_view_sagas',
            controller: SagaListingViewController::class,
            read: false,
            output: false,
        ),
    ],
...
final readonly class SagaListingViewResource {}
